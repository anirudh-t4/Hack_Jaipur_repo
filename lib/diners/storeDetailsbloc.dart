...
class MyStorePageBLoc extends ChangeNotifier{
 ...
 String uid;
  ...
  Future<bool> add2cart(String itemName,double itemPrice) async {
    print(this.store.id);
    ...
    if (cartOfShop.data == null) {
      ...
      t['items'] = [{'itemName':itemName,'itemPrice':itemPrice,'quantity':1}];
      ...
      if(index==-1){
      items.add({'itemName':itemName,'itemPrice':itemPrice,'quantity':1});}
      else{
