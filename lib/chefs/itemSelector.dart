...
import 'package:maps/chefs/itemSelectionTile.dart';
import 'package:maps/models/itemcatalog.dart';
...
class _ItemSelectorPageState extends State<ItemSelectorPage> {
  ...
  _loadAvailableItemsList()async{
    ...
    for(int i=0;i<docs.length;i++){
      temp.add(ItemListingModel(docs[i].data['price'],docs[i].data['itemName']));
    }
    setState(() {
