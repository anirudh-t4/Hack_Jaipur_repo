...
class PerOrder extends StatefulWidget {
  ...
  @override
  _PerOrderState createState() =>
      _PerOrderState(orderData: orderData, distance: distance);
}

class _PerOrderState extends State<PerOrder> {
  final OrderData orderData;
  final double distance;
  double billamount = 0.0;
  _PerOrderState({this.orderData, this.distance});
